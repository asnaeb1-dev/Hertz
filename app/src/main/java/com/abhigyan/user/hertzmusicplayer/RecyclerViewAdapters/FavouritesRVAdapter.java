...
public class FavouritesRVAdapter extends RecyclerView.Adapter<FavouritesRVAdapter.Viewholder>
{
    ...
    public FavouritesRVAdapter(Context context, ArrayList<String> trackNameAL, ArrayList<String> albumNameAL, ArrayList<Long>albumIDAL/*ArrayList<Bitmap> coverPicsAL*/) {
