package com.abhigyan.user.hertzmusicplayer.Databases;
...
public class Mood5DB extends SQLiteOpenHelper {

    private static final String DATABASE_NAME = "crying.db";
    private static final int DATABASE_VERSION = 1;
    public static  final String TABLE_NAME = "MY_MOOD_1";
    ...
    public Mood5DB(Context context ) {
